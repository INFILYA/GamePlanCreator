...
const aboutFirstPage = (
  <div>
    За допомогою цієї програми ви зможете швидко та легко складати плани на поєдинки. Незалежно від
    вашого досвіду та рівня гри, програма допоможе вам організувати стратегію для вашої команди. Ви
    зможете обрати склад з існуючих колективів ПВЛУ, обрати стартовий розташунок гравців на
    майданчику та підкрутити його під свої потреби.
